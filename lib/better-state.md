...
- `SPOOL_DIR` (the literal spool path; it cannot be re-derived, and the bodies are read four times (Phase 2 Foundation grouping, Phase 2 filers, Phase 3c workers, Phase 4c.1 triage), so it is removed in Phase 7, not before)
