...
- Commands with autonomous behavior now support `--interactive` flag to opt into user prompts and approval checkpoints: `do:better`, `do:better-swift`, `do:goals`, `do:release`, `do:replan`, `do:rpr`
...
**Full Diff**: https://github.com/atomantic/slashdo/compare/v1.9.0...v2.0.0
