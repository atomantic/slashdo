...
- `commands/do/release.md`, `commands/do/pr.md`, `commands/do/fpr.md`: Strengthened code review section with REQUIRED GATE language, per-file read requirements, and verification checklist to prevent skipping the deep review before opening PRs
